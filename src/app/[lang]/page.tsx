      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: `https://your-domain.com/${lang}`,
            image: `https://your-domain.com${data.profile.avatarUrl}`,
            email: data.profile.email,
            sameAs: [
              linkedinUrl,
              data.socials.find((s) => s.iconName === "github")?.url,
            ].filter(Boolean),
            address: {
              "@type": "PostalAddress",
        ...
        <div className="max-w-2xl mx-auto px-6 py-12 md:py-20">
          ...
          {sideProjects.length > 0 && (
            <section className="mb-16">
              <h2 className="font-semibold text-sage-dark dark:text-cream mb-6 flex items-center gap-2">
